...
2. **Check the version**: this plugin's workflows need **4.1.3 or newer** (the `fluree model` family). If older, recommend upgrading via the user's original install method before continuing.
